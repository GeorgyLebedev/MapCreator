	...
	<div class="modal-window">
		...
		<aside class="side-menu">
			...
			<div v-else class=" stamp-kit-name">
			    ...
			    <div class="flex-row">
				<svg class="svg-cross-tick" viewBox="0 0 24 24" width="30px" xmlns="http://www.w3.org/2000/svg" @click="()=>{
                     editKitName=''
                     editKit={}
                   }">
				...
				<transition name="scale">
				    <svg v-if="editKitName.length>=5" class="svg-cross-tick" fill="none" viewBox="0 -0.5 25 25" width="30px" xmlns="http://www.w3.org/2000/svg" @click="updateKitName(key)">
			...
			<div v-if="addNewKit" class="stamp-kit-name-container ">
				...
				<div class="flex-row">
				    ...
				    <svg v-if="newKitName.length>=5" class="svg-cross-tick" fill="none" viewBox="0 -0.5 25 25" width="30px" xmlns="http://www.w3.org/2000/svg" @click="addKit">
					<path d="M5.5 12.5L10.167 17L19.5 8" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/>
				    </svg>
				</div>
			    </div>
		...
		<div v-if="selectedKit" class="stamp-list">
			...
			<svg class="delete-stamp-button" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" @click.prevent="showStampDeleteConfirm(key)">
			    ...
			    <path class="svg-orange" d="M16 8L8 16M8.00001 8L16 16M21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12Z" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/>
			</svg>
